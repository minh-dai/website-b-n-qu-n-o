<%-- 
    Document   : banner
    Created on : May 10, 2016, 7:34:47 PM
    Author     : TUNGDUONG
--%>
                ...
                <div class="banner">
                    ...
                    <div class="slider">
                        <ul class="rslides" id="slider1">
                            <li><img src="images/anh1.jpg" alt="">
                            </li>
                            <li><img src="images/anh2.jpg" alt="">
                            </li>
                            <li><img src="images/anh3.jpg" alt="">
                            </li>
<!--                            <li><img src="images/anh4.jpg" alt="">
                            </li>-->
                        </ul>
                    </div>
