...
public final class manager_005fproduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <h3>Quản Lý Sản Phấm</h3>\n");
      out.write("                    \n");
      out.write("                    <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${root}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      ...
      out.write("                            <th class=\"data\">Mã thể loại</th>\n");
      out.write("                            <th class=\"data\">Tên sản phẩm</th>     \n");
      out.write("                            <th class=\"img-responsive\" >Ảnh</th>\n");
      out.write("                            <th class=\"data\">Gía</th>\n");
      ...
      out.write("\n");
      out.write("                        <tr class=\"data\">\n");
      out.write("                            <td class=\"data\" width=\"30px\"><center>");
      out.print(count);
      out.write("</center></td>\n");
      out.write("                            <td class=\"data\" width=\"50px\"><center>");
      out.print(p.getProductID());
      out.write("</center></td>\n");
      out.write("                            <td class=\"data\" width=\"50px\"><center>");
      out.print(p.getCategoryID());
      out.write("</center></td>\n");
      out.write("                            <td class=\"data\" width=\"70px\"><center>");
      out.print(p.getProductName());
      out.write("</center></td>\n");
      out.write("                            <td class=\"img-responsive\" width=\"150px\" height = \"150px\">\n");
      out.write("                                <img  src=\"/ShopQuanAo/");
      out.print(p.getProductImage());
      out.write("\" alt=\"\" />\n");
      out.write("                            </td>\n");
      out.write("                            <td class=\"data\" width=\"60px\">");
      out.print(p.getProductPrice());
      out.write("</td>\n");
      out.write("                            <td class=\"data\" width=\"150px\">");
      ...
      out.print(p.getProductPrice());
      out.write("&product_mota=");
      out.print(p.getProductDescription());
      out.write("\">Sửa</a>\n");
      out.write("                                    <br>\n");
      out.write("                                    <br>\n");
      out.write("                                    <br>\n");
      out.write("                                    <a href=\"/ShopQuanAo/ManagerProductServletTest?command=delete&product_id=");
      out.print(p.getProductID());
      out.write("\">Xóa</a>\n");
      out.write("                                </center>\n");
      out.write("                             </td>\n");
